...
export class HomePage implements OnInit{
  ...
  public seguimentos = [
    ...
    {id: 2, nome: 'Petiscos', img:'assets/img/rauau/icones_slides/petisco.png'},
    {id: 3, nome: 'Ossos', img:'../../assets/img/rauau/icones_slides/osso.png'},
    {id: 4, nome: 'Brinquedos', img:'../../assets/img/rauau/icones_slides/Briquedos.png'},
  ];
  ...
  // public promo: any = [
  //   {id:1, img:'assets/img/promo/banner_marcas.png'},
  //   // {id:2, img:'assets/img/promo/Banner.png'},
  //   // {id:3, img:'assets/img/promo/banner-dose-dupla.jpg'},
  //   {id:4, img:'assets/img/promo/Banner_site_pasta.png'},
  //   {id:5, img:'assets/img/promo/INVERNO_SITE_pasta.png'},
  ...
  public cupom: any = [
    {id:1, img:'assets/img/promo/BURGER_MOBILE.jpg'},
    // {id:2, img:'assets/img/promo/COMBO2.png'},
    // {id:3, img:'assets/img/promo/NOVOS_30.jpg'},
  ];
  public CardDesconto: any = [
    {id:1, nome:'Organnact', marca: 'Promum Dog', preco:'R$ 64,90', desconto:'R$ 18,00',  img:'../../assets/img/rauau/Produtos/Organnact_Promun_Dog.png'},
    {id:1, nome:'Antipulgas e Carrapatos  MSD para Cães de 20Kg a 40Kg', marca: 'Promum Dog', preco:'R$ 237,92', desconto:'R$ 15,00',  img:'../../assets/img/rauau/Produtos/bravecto.jpg'},

  ];

  public marcas = [
    {id:1, marca:'pedigre', img:'../../assets/img/rauau/marcas/pedigre.png'},
    {id:1, marca:'whiskas', img:'../../assets/img/rauau/marcas/whiskas.png'},
    {id:1, marca:'golden', img:'../../assets/img/rauau/marcas/golden.png'}
  ];

  public fixo: any = [
    {id:1, nome:'Ração Golden Special Sabor Frango e Carne ', marca:'Premier Pet', tipo:'Golden', preco:'R$ 132,99', desconto: 'R$ 18,00', img:'../../assets/img/rauau/Produtos/Ração Golden Special Sabor Frango e Carne.png', categoria: "Golden"},
    {id:1, nome:'Ração Golden Special Sabor Frango e Carne ', marca:'Premier Pet', tipo:'Golden', preco:'R$ 132,99', desconto: 'R$ 18,00', img:'../../assets/img/rauau/Produtos/Ração Golden Special Sabor Frango e Carne.png'},
    {id:1, nome:'Ração Golden Special Sabor Frango e Carne ', marca:'Premier Pet', tipo:'Golden', preco:'R$ 132,99', desconto: 'R$ 18,00', img:'../../assets/img/rauau/Produtos/Ração Golden Special Sabor Frango e Carne.png'},
    {id:1, nome:'Ração Golden Special Sabor Frango e Carne ', marca:'Premier Pet', tipo:'Golden', preco:'R$ 132,99', desconto: 'R$ 18,00', img:'../../assets/img/rauau/Produtos/Ração Golden Special Sabor Frango e Carne.png'}
  ...
  enderecoPrincipal() {
    ...
    this.geoLocation.locationTolllbarHome(id)
      .toPromise()
      .then(resp => {
  ...
  getFranquias() {
    this.franquiaService.getFranquias()
          .toPromise()
          .then(resp =>{
